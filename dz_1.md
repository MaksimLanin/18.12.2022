...
### Основные команды
 1. git remote add origin <Ссылка> - привязка к определенному репозиторию через ссылку
 2. git branch -M main - переименовываем ветку master в main
 3. git push -u main - отсылаем 
 Этого алгоритма хватит что бы отправить репозиторий в интернет